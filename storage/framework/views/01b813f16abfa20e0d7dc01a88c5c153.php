...
<?php $__env->startSection('title', 'Top Up - ' . $diamond->name . ' | GOC TopUp'); ?>
            ...
            <div class="flex items-center justify-center">
                <div class="text-center">
                    <div class="flex justify-center mb-8">
                        <a href="<?php echo e(route('games.show', $diamond->game->slug)); ?>" class="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-slate-100 to-slate-300 text-primary-dark font-bold rounded-2xl shadow hover:bg-slate-200 transition-all duration-300 text-lg border border-primary/20">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-slate-200 p-8 mb-8 relative overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="w-32 h-32 bg-gradient-to-br from-primary to-primary-dark rounded-3xl overflow-hidden shadow-lg border-2 border-primary/30 flex-shrink-0">
                    <?php if($diamond->image && file_exists(public_path($diamond->image))): ?>
                        <img src="<?php echo e(asset($diamond->image)); ?>" alt="<?php echo e($diamond->name); ?>" 
                ...
                <div class="flex-1 text-center md:text-left">
                    <h4 class="text-2xl font-bold text-slate-800 mb-2"><?php echo e($diamond->name); ?></h4>
                    <p class="text-slate-600 text-lg"><?php echo e($diamond->game->name); ?></p>
                </div>
                
                <div class="text-center md:text-right">
                    <div class="text-3xl font-black text-primary">Rp <?php echo e(number_format($diamond->price, 0, ',', '.')); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-3xl shadow-xl border border-slate-200 p-8 relative overflow-hidden">
                ...
                <form action="<?php echo e(route('topup.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="diamond_id" value="<?php echo e($diamond->id); ?>">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               class="w-full px-6 py-4 border-2 border-slate-200 rounded-2xl text-lg focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all duration-300 <?php $__errorArgs = ['game_id'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-8">
                        ...
                        <select class="w-full px-6 py-4 border-2 border-slate-200 rounded-2xl text-lg focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all duration-300 <?php $__errorArgs = ['payment_method'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500/10 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="ewallet" <?php echo e(old('payment_method') == 'ewallet' ? 'selected' : ''); ?>>
                            ...
                            <option value="credit_card" <?php echo e(old('payment_method') == 'credit_card' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="max-w-6xl mx-auto mt-8">
            <?php echo $__env->make('components.payment-methods', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\qr\resources\views/topup/create.blade.php ENDPATH**/ ?>