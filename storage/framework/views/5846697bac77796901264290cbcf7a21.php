...
<?php $__env->startSection('title', 'Games - GOC TopUp'); ?>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-primary/30 hover:-translate-y-2 h-full flex flex-col">
                        ...
                        <div class="h-48 bg-gradient-to-br from-primary to-primary-dark relative overflow-hidden">
                            <?php if($game->image && file_exists(public_path($game->image))): ?>
                                <img src="<?php echo e(asset($game->image)); ?>" alt="<?php echo e($game->name); ?>" 
                        ...
                        <div class="p-6 flex flex-col flex-grow">
                            <h3 class="text-xl font-bold text-gray-900 mb-3 text-center"><?php echo e($game->name); ?></h3>
                            <p class="text-gray-600 text-sm leading-relaxed mb-6 flex-grow"><?php echo e(Str::limit($game->description, 80)); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\qr\resources\views/games/index.blade.php ENDPATH**/ ?>