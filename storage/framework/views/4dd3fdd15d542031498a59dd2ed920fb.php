    ...
    <div class="container mx-auto px-4 lg:px-6">
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center">
                <a href="<?php echo e(route('home.index')); ?>" class="flex items-center space-x-3 group" aria-label="GOC TopUp Beranda">
            ...
            <nav class="hidden lg:flex items-center space-x-1" aria-label="Main Navigation">
                <a href="<?php echo e(route('home.index')); ?>" class="nav-link"><i class="fas fa-home mr-2"></i>Beranda</a>
                <a href="<?php echo e(route('games.index')); ?>" class="nav-link"><i class="fas fa-gamepad mr-2"></i>Games</a>
                <a href="<?php echo e(route('promo.index')); ?>" class="nav-link relative"><i class="fas fa-gift mr-2"></i>Promo<span class="absolute -top-1 -right-1 w-2 h-2 bg-red-500 rounded-full animate-pulse"></span></a>
                <a href="<?php echo e(route('history.index')); ?>" class="nav-link"><i class="fas fa-history mr-2"></i>Riwayat</a>
                <a href="<?php echo e(route('guide.index')); ?>" class="nav-link"><i class="fas fa-question-circle mr-2"></i>Panduan</a>
                ...
                <div class="relative group">
                    ...
                    <div id="more-menu" class="absolute top-full left-0 mt-2 w-44 bg-white rounded-lg shadow-xl border border-slate-100 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 origin-top will-change-transform transform scale-95 group-hover:scale-100">
                        <a href="<?php echo e(route('faq.index')); ?>" class="dropdown-item"><i class="fas fa-comments mr-3 w-4"></i>FAQ</a>
                        <a href="<?php echo e(route('support.index')); ?>" class="dropdown-item"><i class="fas fa-headset mr-3 w-4"></i>Bantuan</a>
            ...
            <div class="flex items-center space-x-3">
                <div class="hidden md:block relative group">
                    ...
                    <div class="absolute top-full left-0 right-0 mt-2 bg-white rounded-lg shadow-xl border border-slate-100 py-2 hidden group-focus-within:block origin-top-left will-change-transform transform scale-95">
                        ...
                        <a href="<?php echo e(route('games.index')); ?>" class="search-item"><i class="fas fa-mobile-alt mr-3 text-blue-500"></i><span>Mobile Legends</span></a>
                        <a href="<?php echo e(route('games.index')); ?>" class="search-item"><i class="fas fa-gamepad mr-3 text-purple-500"></i><span>PUBG Mobile</span></a>
                        <a href="<?php echo e(route('games.index')); ?>" class="search-item"><i class="fas fa-fire mr-3 text-orange-500"></i><span>Free Fire</span></a>
                    </div>
                </div>
                ...
                <?php if(auth()->guard()->guest()): ?>
                    <div class="hidden md:flex items-center space-x-2">
                        <a href="<?php echo e(route('auth.login')); ?>" class="btn-outline"><i class="fas fa-sign-in-alt mr-1.5"></i>Masuk</a>
                        </div>
                <?php else: ?>
                    <div class="hidden md:block relative group">
                        <button class="flex items-center space-x-2 p-2 rounded-lg hover:bg-slate-50 transition-colors duration-200" aria-expanded="false" aria-controls="user-dropdown">
                            ...
                            <div class="text-left">
                                <div class="text-sm font-medium text-slate-800"><?php echo e(Auth::user()->name ?? 'User'); ?></div>
                                <div class="text-xs text-slate-500">Rp <?php echo e(number_format(Auth::user()->balance ?? 125000)); ?></div>
                            </div>
                        ...
                        <div id="user-dropdown" class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-slate-100 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 origin-top-right will-change-transform transform scale-95 group-hover:scale-100">
                            <div class="px-4 py-3 border-b border-slate-100">
                                <div class="font-medium text-slate-800"><?php echo e(Auth::user()->name ?? 'User'); ?></div>
                                <div class="text-sm text-slate-500"><?php echo e(Auth::user()->email ?? 'user@goc.com'); ?></div>
                            </div>
                            ...
                            <a href="<?php echo e(route('history.index')); ?>" class="dropdown-item"><i class="fas fa-history mr-3 w-4"></i>Riwayat</a>
    ...
    <div class="md:hidden fixed inset-0 bg-black/40 z-50 opacity-0 invisible transition-all duration-300" id="mobile-overlay">
        <div class="absolute right-0 top-0 h-full w-72 bg-white shadow-xl transform translate-x-full transition-transform duration-300" id="mobile-menu" role="dialog" aria-modal="true" aria-labelledby="mobile-menu-label">
            ...
            <?php if(auth()->guard()->guest()): ?>
                <div class="p-4 border-b border-slate-200">
                    <div class="space-y-2">
                        <a href="<?php echo e(route('auth.login')); ?>" class="w-full btn-primary justify-center"><i class="fas fa-sign-in-alt mr-2"></i>Masuk ke Akun</a>
                        <a href="<?php echo e(route('auth.register')); ?>" class="w-full btn-outline justify-center"><i class="fas fa-user-plus mr-2"></i>Daftar Sekarang</a>
                    </div>
                </div>
            <?php else: ?>
                <div class="p-4 border-b border-slate-200">
                    <div class="flex items-center space-x-3 p-3 bg-slate-50 rounded-lg">
                        ...
                        <div>
                            <div class="font-medium text-slate-800"><?php echo e(Auth::user()->name ?? 'User'); ?></div>
                            <div class="text-sm text-slate-500"><?php echo e(Auth::user()->email ?? 'user@goc.com'); ?></div>
                            <div class="text-xs text-green-600 font-medium">Saldo: Rp <?php echo e(number_format(Auth::user()->balance ?? 125000)); ?></div>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="py-2 flex-1 overflow-y-auto">
                <a href="<?php echo e(route('home.index')); ?>" class="mobile-nav-link"><i class="fas fa-home mr-3 w-4"></i>Beranda</a>
                <a href="<?php echo e(route('games.index')); ?>" class="mobile-nav-link"><i class="fas fa-gamepad mr-3 w-4"></i>Games</a>
                <a href="<?php echo e(route('promo.index')); ?>" class="mobile-nav-link"><i class="fas fa-gift mr-3 w-4"></i>Promo<span class="ml-auto w-2 h-2 bg-red-500 rounded-full"></span></a>
                <a href="<?php echo e(route('history.index')); ?>" class="mobile-nav-link"><i class="fas fa-history mr-3 w-4"></i>Riwayat</a>
                <a href="<?php echo e(route('guide.index')); ?>" class="mobile-nav-link"><i class="fas fa-question-circle mr-3 w-4"></i>Panduan</a>
                <a href="<?php echo e(route('faq.index')); ?>" class="mobile-nav-link"><i class="fas fa-comments mr-3 w-4"></i>FAQ</a>
                <a href="<?php echo e(route('support.index')); ?>" class="mobile-nav-link"><i class="fas fa-headset mr-3 w-4"></i>Bantuan</a>
...
</script><?php /**PATH C:\laragon\www\qr\resources\views/components/header.blade.php ENDPATH**/ ?>