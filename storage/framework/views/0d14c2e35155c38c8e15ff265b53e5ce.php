...
<?php $__env->startSection('title', $game->name . ' - Pilih Diamond | Goc TopUp'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative min-h-[60vh] flex items-end justify-center overflow-hidden pb-8">
        <!-- Background -->
        <?php if($game->image && file_exists(public_path($game->image))): ?>
            <img src="<?php echo e(asset($game->image)); ?>"
                 alt="<?php echo e($game->name); ?>"
                 class="absolute inset-0 w-full h-full object-cover">
        <?php elseif($game->image && Storage::disk('public')->exists($game->image)): ?>
        ...
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 justify-center mx-auto w-fit">
                <?php $__currentLoopData = $diamonds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $diamond): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group"
                         onclick="selectDiamond(event, <?php echo json_encode($diamond->id, 15, 512) ?>, <?php echo json_encode($diamond->name, 15, 512) ?>, <?php echo json_encode($diamond->price, 15, 512) ?>)">
                        <div class="bg-gradient-to-br from-white via-slate-50 to-slate-100 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border-2 border-slate-200 hover:border-primary/50 hover:-translate-y-2 cursor-pointer h-full flex flex-col relative">
                            ...
                            <div class="h-20 bg-gradient-to-br from-primary via-blue-600 to-primary-dark relative overflow-hidden flex items-center justify-center">
                                ...
                                <div class="relative z-10 flex items-center justify-center">
                                    ...
                                    <span class="text-white font-bold text-lg"><?php echo e($diamond->name); ?></span>
                                </div>

                                <!-- Popular Badge -->
                                <?php if($diamond->is_popular): ?>
    ...
    Rp <?php echo e(number_format($diamond->price ?? 0, 0, ',', '.')); ?>
...
<div class="w-12 h-0.5 bg-gradient-to-r from-primary to-blue-600 mx-auto mt-2 rounded-full"></div>
                                ...
                                <!-- Purchase Button -->
                                <button onclick="event.stopPropagation(); proceedToTopUp(<?php echo e($diamond->id); ?>)"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\qr\resources\views/games/show.blade.php ENDPATH**/ ?>