...
<?php $__env->startSection('title', 'Promo & Bonus - GOC TopUp'); ?>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="<?php echo e(route('home.index')); ?>" class="btn-outline text-lg px-8 py-4 border-white text-white hover:bg-white hover:text-accent">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="card-hover group relative overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <a href="<?php echo e(route('games.index')); ?>" class="btn-primary w-full text-center">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="card-hover group">
                    ...
                    <a href="<?php echo e(route('games.index')); ?>" class="btn-accent w-full text-center">
                        <i class="fas fa-shopping-cart mr-2"></i>
                        Beli Sekarang
                    </a>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\qr\resources\views/promo/index.blade.php ENDPATH**/ ?>