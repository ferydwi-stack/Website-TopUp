            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
                <form action="{{ route('auth.login') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('auth.forgot-password') }}" class="text-sm text-primary hover:text-primary-dark font-medium transition-colors duration-200">
                            Lupa password?
                        </a>
                    </div>
  ...
  Masuk
                ...
                <div class="text-center mt-8">
                    <p class="text-gray-600">
                        Belum punya akun? 
                        <a href="{{ route('auth.register') }}" class="text-primary hover:text-primary-dark font-semibold transition-colors duration-200">
                            Daftar sekarang
                        </a>
                    </p>
                </div>
