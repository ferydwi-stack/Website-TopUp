...
@section('title', 'Beranda - GOC TopUp')
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center max-w-5xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('games.index') }}" class="btn-accent text-lg px-8 py-4 transform hover:scale-105 transition-all duration-300">
    ...
    <section id="games" class="py-16 md:py-20 bg-gradient-to-br from-slate-50 to-blue-50 relative">
        <div class="container mx-auto px-4">
                ...
                <div class="card-hover group transform hover:scale-105 transition-all duration-300">
                    <div class="relative overflow-hidden rounded-2xl">
                        ...
                        <div class="absolute bottom-4 left-4 right-4">
                            ...
                            <a href="{{ route('games.index') }}" class="btn-primary text-sm px-4 py-2">
                                Top Up Sekarang
                            </a>
                        </div>
                    </div>
            ...
            <div class="text-center mt-12">
                <a href="{{ route('games.index') }}" class="btn-outline text-lg px-8 py-4 border-primary-600 text-primary-600 hover:bg-primary-600 hover:text-white transform hover:scale-105 transition-all duration-300">
                    <i class="fas fa-gamepad mr-2"></i>
                    Lihat Semua Game
                </a>
            </div>
    ...
    <section class="py-16 md:py-20 bg-gradient-to-r from-primary-600 via-primary-700 to-primary-800 text-white relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="{{ route('auth.register') }}" class="btn-outline text-lg px-8 py-4 border-white text-white hover:bg-white hover:text-primary-600 transform hover:scale-105 transition-all duration-300">
