    ...
    <div class="container mx-auto px-4 py-16 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('home.index') }}" class="text-slate-300 hover:text-primary-400 transition-colors duration-200 flex items-center">
                            <i class="fas fa-chevron-right mr-2 text-xs text-primary-500"></i>
                            Beranda
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('games.index') }}" class="text-slate-300 hover:text-primary-400 transition-colors duration-200 flex items-center">
                            <i class="fas fa-chevron-right mr-2 text-xs text-primary-500"></i>
                            Games
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('promo.index') }}" class="text-slate-300 hover:text-primary-400 transition-colors duration-200 flex items-center">
                            <i class="fas fa-chevron-right mr-2 text-xs text-primary-500"></i>
                            Promo
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('guide.index') }}" class="text-slate-300 hover:text-primary-400 transition-colors duration-200 flex items-center">
                            <i class="fas fa-chevron-right mr-2 text-xs text-primary-500"></i>
                            Cara Top Up
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('faq.index') }}" class="text-slate-300 hover:text-primary-400 transition-colors duration-200 flex items-center">
                            <i class="fas fa-chevron-right mr-2 text-xs text-primary-500"></i>
                            FAQ
                        </a>
                    </li>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('support.index') }}" class="text-slate-300 hover:text-primary-400 transition-colors duration-200 flex items-center">
                            <i class="fas fa-chevron-right mr-2 text-xs text-primary-500"></i>
                            Hubungi Kami
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('history.index') }}" class="text-slate-300 hover:text-primary-400 transition-colors duration-200 flex items-center">
                            <i class="fas fa-chevron-right mr-2 text-xs text-primary-500"></i>
                            Riwayat Transaksi
                        </a>
                    </li>
